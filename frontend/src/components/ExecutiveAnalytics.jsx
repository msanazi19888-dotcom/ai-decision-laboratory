...
function ExecutiveAnalytics({
  ...
  return (
    <div className="card" id="executive-analytics">
      ...
      {!loading && !error && (
        <>
          ...
          <div className="analytics-grid dashboard-section">
            <DecisionTrendChart data={analytics.trend} />
            <StrategyDistributionChart data={analytics.strategy_distribution} />
          </div>

          <div className="analytics-grid dashboard-section">
            <DecisionStatusChart data={analytics.status_distribution} />
            <ExecutiveSummary kpis={analytics.kpis} />
          </div>

          <RecentDecisionTable decisions={recentDecisions} />
        </>
      )}
    </div>
  );
